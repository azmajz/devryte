      ...
      <div class="container">
        ...
        <section class="lessons-section">
          <div class="lessons-header">
            ...
            <button class="btn btn-primary btn-sm" @click="showAddModal = true" id="add-lesson-btn">
          ...
          <div class="modal-card">
            ...
            <div class="modal-body">
              <div class="form-group">
                ...
                <input type="text" class="form-input" placeholder="e.g. Introduction to Generics" id="lesson-title-input" />
              </div>
            </div>
            <div class="modal-footer">
              ...
              <NuxtLink
                v-if="topic"
                :to="`/topics/${topic.slug}/lessons/new/edit`"
